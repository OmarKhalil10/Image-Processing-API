...
var imageUtilities_1 = __importDefault(
  require('../../utilities/imageUtilities')
);
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          fullImagePath = ''.concat(
            path_1.default.resolve(
              __dirname,
              '../../../my-images/all/'.concat(filename, '.jpg')
            )
          );
          thmbnailImagePath = ''.concat(
            path_1.default.resolve(
              __dirname,
              '../../../my-images/thumbnail/'
                .concat(filename, '-')
          ...
          return [
            4 /*yield*/,
            promises_1.default.stat(fullImagePath).catch(function () {
        ...
        case 1:
          ...
          return [
            4 /*yield*/,
            promises_1.default.stat(thmbnailImagePath).catch(function () {
              return null;
            }),
          ];
        case 2:
